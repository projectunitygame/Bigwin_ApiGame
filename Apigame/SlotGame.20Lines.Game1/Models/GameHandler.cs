...
using SlotGame._20Lines.Game1.Hubs;
...
namespace SlotGame._20Lines.Game1.Models
{
    public class GameHandler : IGameHandler
    {
        ...
        private readonly ISlotMachineDAO _slotMachineDAO = ADODAOFactory.Instance().CreateSlotMachineDAO();
        ...
        public long FinishBonusGame(MoneyType moneyType, int spinId, ref long prizeValue, ref long balance)
        {
            ...
            var responeStatus = _slotMachineDAO.FinishBonusGame(moneyType, spinId, ref prizeValue, ref balance);
