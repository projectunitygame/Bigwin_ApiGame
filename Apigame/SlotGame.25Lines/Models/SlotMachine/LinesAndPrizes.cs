...
{
    public class LinesAndPrizes
    {
        private static readonly Lazy<LinesAndPrizes> _instance = new Lazy<LinesAndPrizes>(() => new LinesAndPrizes());
        ...
        private LinesAndPrizes()
        {
            Init();
        }

        public static LinesAndPrizes Instance => _instance.Value;
        ...
        private void Init()
        {
            ...
            {
                new Prize() {PrizeId = 1, PrizeName = "5 Wilds", Multiplier = 0},
                new Prize() {PrizeId = 2, PrizeName = "4 Wilds", Multiplier = 0},
                new Prize() {PrizeId = 3, PrizeName = "3 Wilds", Multiplier = 0},
                new Prize() {PrizeId = 4, PrizeName = "5A", Multiplier = 0},
                new Prize() {PrizeId = 5, PrizeName = "4A", Multiplier = 150},
                new Prize() {PrizeId = 6, PrizeName = "3A", Multiplier = 50},
                new Prize() {PrizeId = 7, PrizeName = "5B", Multiplier = 300},
                new Prize() {PrizeId = 8, PrizeName = "4B", Multiplier = 75},
                new Prize() {PrizeId = 9, PrizeName = "3B", Multiplier = 40},
                new Prize() {PrizeId = 10, PrizeName = "5C", Multiplier = 150},
                new Prize() {PrizeId = 11, PrizeName = "4C", Multiplier = 50},
                new Prize() {PrizeId = 12, PrizeName = "3C", Multiplier = 30},
                new Prize() {PrizeId = 13, PrizeName = "5D", Multiplier = 100},
                new Prize() {PrizeId = 14, PrizeName = "4D", Multiplier = 35},
                new Prize() {PrizeId = 15, PrizeName = "3D", Multiplier = 20},
                new Prize() {PrizeId = 16, PrizeName = "5E", Multiplier = 40},
                new Prize() {PrizeId = 17, PrizeName = "4E", Multiplier = 20},
                new Prize() {PrizeId = 18, PrizeName = "3E", Multiplier = 10},
                new Prize() {PrizeId = 19, PrizeName = "5F", Multiplier = 25},
                new Prize() {PrizeId = 20, PrizeName = "4F", Multiplier = 10},
                new Prize() {PrizeId = 21, PrizeName = "3F", Multiplier = 5},
                new Prize() {PrizeId = 22, PrizeName = "5G", Multiplier = 15},
                new Prize() {PrizeId = 23, PrizeName = "4G", Multiplier = 9},
                new Prize() {PrizeId = 24, PrizeName = "3G", Multiplier = 3},
                new Prize() {PrizeId = 25, PrizeName = "5H", Multiplier = 8},
                new Prize() {PrizeId = 26, PrizeName = "4H", Multiplier = 4},
                new Prize() {PrizeId = 27, PrizeName = "3H", Multiplier = 2},
            };
        }
