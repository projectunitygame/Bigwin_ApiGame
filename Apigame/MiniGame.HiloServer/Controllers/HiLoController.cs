...
namespace Minigame.Public.Controllers
{
    ...
    {
        private readonly IHiloDao repository = AbstractDaoMinigame.Instance().CreateMiniHiloDao();
        ...
        public HttpResponseMessage GetAccountHistory(int betType, int topCount = 10)
        {
            ...
            try
            {
                ...
                NLogManager.LogMessage("HiloGetHistory:" + AccountSession.AccountID +
                ...
                {
                    listGetAccountHistory = new List<HiLoGetAccountHistory>();
                }
        ...
        public HttpResponseMessage GetTopWinners(int betType, int topCount = 10)
        {
            ...
            try
            {
                ...
                var listTopWinner = repository.GetTopAccount(betType, topCount);

                return HttpUtils.CreateResponse(HttpStatusCode.OK, JsonConvert.SerializeObject(listTopWinner), "GetTopWinners Success");
            }
